...
return {
  {
    ...
    config = tie(
      ...
      function(_, opts)
        ...
        -- Add draw options here for readability
        opts.draw = vim.tbl_deep_extend("force", opts.draw, {
          predicate = tie(
            ...
            function(scope)
              ...
              return not scope.body.is_incomplete and scope_lines > extra_opts.min_lines
            end,
